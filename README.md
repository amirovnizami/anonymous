...
To update the database use this command from the Web project folder (replace `Project2` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Project2.Infrastructure/Project2.Infrastructure.csproj -s Project2.Web.csproj
```
